...
const Collection = () => {
  ...
  const sortProduct = () => {
    let filtetProductCopy = filterProducts.slice();

    switch(sortType){
      case "low-high":
        setFilterProducts(filtetProductCopy.sort((a,b)=>(a.price - b.price)));
        break;
      case "high-low":
        setFilterProducts(filtetProductCopy.sort((a,b)=>(b.price - a.price)));
        break;
      default:
        applyFilter();
        break;
