...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between  py-5 font-medium'>
        ...
        <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}> {/* Here we are using the dynamic class [means here we are using the state variable and whe the variable changes then i will change the class name] */}
